...
<form name="PGIOForm">
    ...
    <table border=0 cellpadding=0>
        <tr>
            <th>ReceiptToName</th>
            <th name=receipttoname value="사용자">사용자</th>
        </tr>
        <tr> </tr>
        <tr></tr>
        <tr>
        ...
        <tr>
            <th>GoodName</th>
            <th name=goodname value="테스트">테스트</th>

        </tr>
        <tr>
            <th>Price</th>
            <th><input type="hidden" name=unitprice value="1000" size=7>1000원</th>
            <!--<th name=unitprice value="1000" size=7>1000원</th><div name=goodcurrency value="WON"></div>-->
        </tr>
        <tr></tr>
        <tr></tr>
        <tr>
